...
ALTER TYPE "ComponentType" ADD VALUE 'TESTIMONIALS';
ALTER TYPE "ComponentType" ADD VALUE 'FEATURED_COLLECTION';
ALTER TYPE "ComponentType" ADD VALUE 'COUNTDOWN_TIMER';
ALTER TYPE "ComponentType" ADD VALUE 'NEWSLETTER_SIGNUP';
ALTER TYPE "ComponentType" ADD VALUE 'FAQ_ACCORDION';
ALTER TYPE "ComponentType" ADD VALUE 'BANNER_CAROUSEL';
...
-- AddForeignKey
ALTER TABLE "coupons" ADD CONSTRAINT "coupons_vendorId_fkey" FOREIGN KEY ("vendorId") REFERENCES "vendor_profiles"("id") ON DELETE CASCADE ON UPDATE CASCADE;
