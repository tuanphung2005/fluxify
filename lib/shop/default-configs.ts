        ...
        testimonials: [
            {
                name: "John Doe",
                rating: 5,
                comment: "Amazing products and fast shipping! Highly recommend this store.",
                role: "Verified Buyer",
            },
            {
                name: "Jane Smith",
                rating: 5,
                comment: "Great quality and excellent customer service. Will buy again!",
                role: "Verified Buyer",
            },
        ],
        layout: "carousel",
        ...
        items: [
            {
                ...
                answer: "We offer a 30-day return policy on all items. If you're not satisfied with your purchase, you can return it for a full refund.",
            },
            {
