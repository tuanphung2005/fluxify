        ...
        <Card className={clsx("border-none shadow-md", className)}>
            <CardBody className="p-6">
                <div className="flex justify-between items-start">
                    <div>
                        <p className="text-sm font-medium text-default-600 uppercase tracking-wider">{title}</p>
                        <h3 className="text-4xl font-bold mt-2">{value}</h3>
                    </div>
                    <div className={clsx("p-3 rounded-xl", colorStyles[color] || colorStyles.default)}>
                        <Icon size={24} />
                    </div>
                </div>
                {subtext && (
