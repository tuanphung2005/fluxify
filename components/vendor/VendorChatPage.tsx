        ...
        <div className="p-6 h-[calc(100vh-64px)]">
            <div className="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p className="text-default-500">Quản lý cuộc trò chuyện với khách hàng</p>
                </div>
                {totalUnread > 0 && (
                            ...
                            <>
                                ...
                                <div className="p-4 border-b flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                        <Avatar
                                            src={selectedConversationData?.customer.image || undefined}
                                    ...
                                    <Button
                                        ...
                                        onPress={() => {
                                            ...
                                            window.open(`/shop/${selectedConversationData?.customer.id}`, "_blank");
                                        }}
