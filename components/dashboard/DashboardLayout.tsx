...
import DashboardSidebar, { SidebarMenuItem } from "@/components/common/DashboardSidebar";
...
export default function DashboardLayout({
    ...
    }, [status, session, router, requiredRole, unauthorizedRedirect, loginRedirect]);
    ...
    // Build footer
    const footer = (showSettings || showLogout) ? (
        <>
            {showSettings && (
                <Button
                    variant="light"
