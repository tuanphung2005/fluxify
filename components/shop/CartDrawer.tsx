                      ...
                      return (
                        ...
                        >
                          {item.image ? (
                            ...
                            <div
                              className={`w-20 h-20 bg-default-200 rounded-md flex items-center justify-center text-xs text-default-500 ${!inStock ? "opacity-50" : ""}`}
                            >
                              Không có ảnh
                            </div>
                          )}
                          <div className="flex-1 flex flex-col justify-between">
                            <div>
                              <h3
                                className={`font-medium line-clamp-1 ${!inStock ? "text-default-400" : ""}`}
                              >
                                {item.name}
                              </h3>
                              {item.variantDisplay && (
