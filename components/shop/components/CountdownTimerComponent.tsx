...
export default function CountdownTimerComponent({ config }: CountdownTimerComponentProps) {
    const { title, endDate, subtitle, expiredMessage, backgroundColor, textColor } = config;
            ...
            <div className="max-w-4xl mx-auto text-center">
                ...
                {isExpired ? (
                    ...
                    <div className="flex justify-center gap-4 md:gap-8">
                        ...
                        <div className="flex items-center text-3xl font-light opacity-50">:</div>
