...
function RatingBar({
  ...
  return (
    <button
      className={`flex items-center gap-2 w-full py-1.5 px-2 rounded-lg transition-colors hover:bg-default-100 ${
...
export default function ShopReviewsSection({
  ...
  const [productRatingFilter, setProductRatingFilter] = useState<number | null>(
    null,
  );
  const limit = 5;
