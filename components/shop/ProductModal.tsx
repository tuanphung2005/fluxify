...
export default function ProductModal({ product, vendorId, vendorName, isOpen, onClose }: ProductModalProps) {
    ...
    const handleAddToCart = () => {
        ...
        const variantDisplay = hasProductVariants && currentVariantKey
                    ...
                    <div className="relative grid grid-cols-1 md:grid-cols-2 gap-0 min-h-[600px]">
                        ...
                        <div className="p-8 md:p-12 flex flex-col gap-6 h-full overflow-y-auto">
                            ...
                            {stockStatus === 'out_of_stock' ? (
                                <Chip color="default" variant="flat" size="lg">Hết hàng</Chip>
                            ) : stockStatus === 'low_stock' ? (
                                <Chip color="warning" variant="flat" size="lg">Sắp hết: {currentStock} sản phẩm</Chip>
                            ) : (
                                <Chip color="success" variant="flat" size="lg">Còn hàng</Chip>
                            )}
