...
2. Yêu cầu phi chức năng (NFR) có chỉ số đo lường.
3. Góc nhìn triển khai và vận hành.
4. Bảo mật, rủi ro và biện pháp giảm thiểu.
5. Hồ sơ quyết định kiến trúc (ADR) cho các quyết định quan trọng.
6. Ma trận truy vết yêu cầu và kế hoạch kiểm chứng kiến trúc.

## 2. Thứ tự đọc để bảo vệ

1. [Tổng quan hệ thống](01-system-overview.md)
2. [NFR và kịch bản chất lượng](02-quality-attributes-nfr.md)
3. [Triển khai và vận hành](03-deployment-and-operations.md)
4. [Bảo mật và quản trị rủi ro](04-security-and-risk.md)
5. [Chỉ mục ADR](adr/README.md)
6. [Truy vết và kiểm chứng kiến trúc](05-traceability-and-validation.md)
